...
export const MAP_CHIP_SELECTED_CLASS = "border-brand-coral bg-brand-coral text-primary-foreground";
...
export const MAP_FILTER_PANEL_BASE_CLASS =
  "mt-2 overflow-hidden rounded-2xl border border-border/35 bg-background/88 shadow-[0_8px_20px_rgb(0_0_0_/_0.08)] backdrop-blur-md transition-all duration-200 ease-out";
