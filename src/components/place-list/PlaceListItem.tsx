    ...
    <article className="border-border bg-background border-b px-4 py-3">
      <div className="flex items-start gap-3">
        <button type="button" onClick={() => onSelect(place)} className="min-w-0 flex-1 text-left">
          ...
          {place.memo ? (
            <p className="mt-2 rounded-[5px] bg-[#fde8e8] px-3 py-1.5 text-xs font-medium text-[#4d4d4d]">
              {place.memo}
            </p>
          ) : null}
        </button>
        <button
          type="button"
          className="touch-target-min -mt-2 flex shrink-0 items-center justify-center text-[#777777]"
