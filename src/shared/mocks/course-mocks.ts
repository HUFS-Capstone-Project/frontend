...
/** 목 데이터: legacy place id → roomPlaceId (방 장소 상세 API 연동용) */
export const MOCK_LEGACY_PLACE_ID_TO_ROOM_PLACE_ID: Record<string, number> = {
  "restaurant-1": 10001,
  "cafe-1": 10002,
  "activity-1": 10003,
  "restaurant-3": 10004,
...
function mockStop(
  legacyPlaceId: keyof typeof MOCK_LEGACY_PLACE_ID_TO_ROOM_PLACE_ID,
  stop: Omit<CourseStop, "id" | "roomPlaceId">,
): CourseStop {
  const roomPlaceId = MOCK_LEGACY_PLACE_ID_TO_ROOM_PLACE_ID[legacyPlaceId];
  return {
